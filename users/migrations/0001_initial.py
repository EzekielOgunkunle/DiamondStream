    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('login', 'Login'), ('logout', 'Logout'), ('registration', 'Registration'), ('password_change', 'Password Change'), ('email_verification', 'Email Verification'), ('profile_update', 'Profile Update'), ('investment_created', 'Investment Created'), ('investment_cancelled', 'Investment Cancelled'), ('wallet_added', 'Wallet Added'), ('wallet_updated', 'Wallet Updated'), ('payout_requested', 'Payout Requested'), ('kyc_submitted', 'KYC Submitted'), ('two_factor_enabled', 'Two Factor Enabled'), ('two_factor_disabled', 'Two Factor Disabled')], max_length=50)),
